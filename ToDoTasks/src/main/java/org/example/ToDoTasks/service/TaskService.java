...
public class TaskService {
    ...
    @Autowired // Tell Spring to inject class
    ...
    public TaskDTO updateTask(Long id, TaskDTO taskDto) {
        ...
        // Update all fields - Currently required (PATCH updating/single attributes for update can be added in future)
        ...
        // Call repository to save newly updated task to DB
